...
class LinkedinOauthClient(object):
	...
	def getUserInfo(self):
		...
		link = 'https://api.linkedin.com/v1/people/~:(id,first-name,emailAddress,last-name,skills,educations,languages,twitter-accounts)?oauth2_access_token='+self.access_token
